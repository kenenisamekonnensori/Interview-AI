export function buildFollowUpGuidance() {
  return `### Dynamic Follow-Up Strategy:
- Ask follow-up questions to probe specific candidate assertions, clarify technical trade-offs, or explore unresolved areas.
