...
export default function NewInterviewPage() {
  return (
    <main className="noise min-h-[calc(100vh-5rem)] px-5 py-8 sm:px-8 lg:px-10">
      ...
      <h1 className="mt-2 text-3xl font-semibold tracking-[-.045em] sm:text-[2.5rem]">Create a practice session</h1>
      ...
      <div className="mt-8 flex items-center gap-2 overflow-x-auto pb-1 text-xs sm:text-sm">
        <p className="whitespace-nowrap rounded-full border border-primary/40 bg-primary/10 px-4 py-2 font-medium text-primary">01 · Your resume</p>
        <span className="h-px w-6 shrink-0 bg-border" />
        <p className="whitespace-nowrap rounded-full border border-border bg-card/60 px-4 py-2">02 · Target role</p>
        <span className="h-px w-6 shrink-0 bg-border" />
        <p className="whitespace-nowrap rounded-full border border-border bg-card/60 px-4 py-2">03 · Session details</p>
      </div>
