...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    tagline: "30 practice interviews a month with full progress tracking.",
    monthly: 19,
    annual: 15,
    features: [
      "30 practice interviews each month",
      "All interview types, including technical & system design",
      "Performance analytics & score trends",
      "Skills & weaknesses profile",
      "Personalized practice plan",
      "Advanced AI feedback & job readiness",
    ],
